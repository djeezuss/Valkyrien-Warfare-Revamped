...
public class ShipUUIDToPosData extends WorldSavedData {
	...
	public class ShipPositionData {
		...
		public void writeToByteBuffer(ByteBuffer buffer) {
			buffer.putFloat(shipPosition.X);
			buffer.putFloat(shipPosition.Y);
			buffer.putFloat(shipPosition.Z);
		...
		public void updateData(PhysicsWrapperEntity wrapper) {
			shipPosition.X = (float) wrapper.posX;
			shipPosition.Y = (float) wrapper.posY;
			shipPosition.Z = (float) wrapper.posZ;
			lToWTransform = wrapper.wrapping.coordTransform.lToWTransform.clone();
		}
	}
