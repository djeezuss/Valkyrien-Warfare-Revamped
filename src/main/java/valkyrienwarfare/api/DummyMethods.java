...
public interface DummyMethods {
    ...
    VectorVW getShipCenterOfMass(Entity shipEnt);

    boolean isEntityAShip(Entity entityToTest);

    VectorVW getPositionInShipFromReal(World worldObj, Entity shipEnt, VectorVW positionInWorld);

    VectorVW getPositionInRealFromShip(World worldObj, Entity shipEnt, VectorVW posInShip);
    ...
    VectorVW getLinearVelocity(Entity shipEnt, double secondsToApply);

    VectorVW getAngularVelocity(Entity shipEnt);
    ...
    VectorVW getVelocityAtPoint(Entity shipEnt, VectorVW inBody, double secondsToApply);
