...
public class PhysicsObject {
	...
	private void createPhysicsCalculations() {
		if (physicsProcessor == null) {
			...
			/*
			 * if (shipType == ShipType.Oribtal || shipType ==
			 * ShipType.Semi_Unlocked_Orbital) { physicsProcessor = new
			 * PhysicsCalculationsOrbital(this); } else { if (shipType == ShipType.Zepplin
			 * || shipType == ShipType.Dungeon_Sky) { physicsProcessor = new
			 * PhysicsCalculationsManualControl(this); } else { physicsProcessor = new
			 * IPhysicsManager(this); } }
			 */
		} else {
